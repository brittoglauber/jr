export default function FaqsText() {
  return (
    <div className="w-full flex justify-center items-center mb-[152px]">
      <div className="flex flex-col items-start justify-between max-w-[1194px] text-justify px-5">
        <div
          className="
        ...
        <p className="mt-12 text-[#666C89] text-base font-medium max-[430px]:mt-8">
          O site Transportadora JR Express é de propriedade da empresa JR
          Express Transporte, que é a controladora de seus dados pessoais.
        </p>
        <p className="mt-4 text-[#666C89] text-base font-medium">
          Nós adotamos esta Política de Privacidade, que determina como nós
          estamos processando as informações coletadas pelo site Transportadora
          JR Express e também explica por quais razões nós precisamos coletar
          dados pessoais sobre você. Portanto, você deve ler esta Política de
          Privacidade antes de usar o site Transportadora JR Express.
        </p>
        <p className="mt-4 text-[#666C89] text-base font-medium">
          Nós cuidamos dos seus dados pessoais e assumimos a responsabilidade de
          garantir a confidencialidade e segurança de suas informações pessoais.
        </p>
        ...
        <p className="mt-4 text-[#666C89] text-base font-medium">
          Quando você visita o site Transportadora JR Express, nós
          automaticamente coletamos certas informações sobre seu dispositivo,
          incluindo informações sobre seu navegador, endereço IP, fuso horário e
          alguns dos cookies instalados no seu dispositivo. Além disso, quando
          você navega pelo Site, nós coletamos informações sobre as páginas
          individuais ou produtos que você visualiza, sobre quais sites ou
          termos de busca redirecionaram você para nosso Site, e sobre como você
          interage com o Site. Nós nos referimos a essas informações coletadas
          automaticamente como "Informações sobre o dispositivo". Além disso,
          nós podemos coletar dados pessoais que você fornecer (incluindo, mas
          não limitado a: Nome, Sobrenome, Endereço, informações de pagamento,
          etc) durante o processo de registro para poder cumprir o acordo.
        </p>
        ...
        <p className="mt-4 text-[#666C89] text-base font-medium">
          ...
          quais informações pessoais são obrigatórias são convidados a entrarem
          em contato conosco pelo e-mail comercial@jrexpresstransporte.com.br.
        </p>
        ...
        <ul className="mt-4 text-[#666C89] text-base font-medium">
          <li className="list-disc ml-3">O direito de ser informado</li>
          <li className="list-disc ml-3">O direito ao acesso.</li>
          <li className="list-disc ml-3">O direito à retificação.</li>
          <li className="list-disc ml-3">O direito de deletar.</li>
          ...
          <li className="list-disc ml-3">O direito à objeção.</li>
          <li className="list-disc ml-3">
        ...
        <p className="mt-4 text-[#666C89] text-base font-medium">
          ...
          solicitação do governo. Informações de contato:
        </p>
